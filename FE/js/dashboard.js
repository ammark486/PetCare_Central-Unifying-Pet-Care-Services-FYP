...
let permission_label = 'ADMIN_DASHBOARD'
...
async function selectedYear(){
  ...
  await getYearlyData(); // Wait for getYearlyData to complete before proceeding
}
...
//   const parentItems = document.querySelectorAll('.sidebar-list-item.parent');
