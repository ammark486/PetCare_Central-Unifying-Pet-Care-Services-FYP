...
public interface ProductRepo extends JpaRepository<Product, Long> {
    ...
    @Query(value = "SELECT new com.example.demo.dto.ProductDto(p.id, p.name, p.price, p.imageUrl, p.description, p.age, p.color, p.isActive, pt.type as productType, c.id as categoryId, pt.id as productTypeId)" +
