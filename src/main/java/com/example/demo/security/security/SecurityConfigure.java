...
class SecurityConfigure extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers("/api/product-type/**").permitAll()
                .antMatchers("/api/category/product-type/**").permitAll()
                .antMatchers("/api/product/categoryId").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/vet-feedback/{id}").permitAll()
                .antMatchers(HttpMethod.GET, "/api/avg-rating/{id}").permitAll()
